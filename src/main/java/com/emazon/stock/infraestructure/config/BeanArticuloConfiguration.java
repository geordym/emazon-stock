...
public class BeanArticuloConfiguration {
    ...
    @Bean
    ArticuloService articuloService(final ArticuloRepositoryPort articuloRepositoryPort,  ArticuloValidator articuloValidator){
        return new ArticuloService(new ArticuloUseCasesImpl(articuloRepositoryPort, articuloValidator));
    }
