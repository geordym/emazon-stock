...
public class ArticuloController {
    ...
    public ResponseEntity<List<ArticuloResponseDTO>> listarArticulos(
        ...
        PaginationCustom paginationCustom = articuloService.listArticles(new PaginationParams(page,size,sortBy,ascending));

        // Mapear a DTOs para la respuesta
        List<ArticuloResponseDTO> articuloResponseDTO = paginationCustom.getContent().stream()
